...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class TiltPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference XSensitivity = findPreference("X_Sensitivity");
            bindPreferenceSummaryToValue(XSensitivity);
